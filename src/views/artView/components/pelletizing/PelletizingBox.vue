...
.pelletizing .sign div {
  float: right;
}

.pelletizing .sign .sign-title {
  float: left;
  width: 72px;
  height: 24px;
  color: #fff;
...
.pelletizing .bar-chart .list1::-webkit-scrollbar {
  width: 0;
}

.pelletizing .bar-chart .item {
  width: 350px;
  height: 10px;
  margin-top: 10px;
}

.pelletizing .bar-chart .item .box {
  float: left;
  width: 300px;
  height: 100%;
  overflow: hidden;
...
.pelletizing .bar-chart .item .box .item-gong {
  float: left;
  width: 100px;
  height: 100%;
  background: #0f7ae9;
...
.pelletizing .bar-chart .item .box .item-shou {
  float: left;
  width: 100px;
  height: 100%;
...
.pelletizing .bar-chart .item .item-text {
  float: right;
  color: #fff;
  font-size: 10px;
  font-family: PingFangSC-Medium, PingFang SC;
...
.pelletizing .bar-chart .x-num {
  width: 350px;
  height: 30px;
  position: relative;
}

.pelletizing .bar-chart .x-num span {
  margin-top: 5px;
  color: #fff;
  font-size: 12px;
  font-family: PingFangSC-Medium, PingFang SC;
